...
exports.checkDayTrading = exports.checkThemTest = void 0;
...
var checkDayTrading = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                dates = ['2022-05-23', '2022-05-24', '2022-05-25', '2022-05-26'];
                _loop_1 = function (x) {
                    var todayGainLoss, date, filter, matching, y, current, priceHistory, currentDatePriceHistory, lastEntry, gainLoss;
