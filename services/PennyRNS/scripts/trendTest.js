...
var getHistoricalData = function (ticker, start, end) { return __awaiter(void 0, void 0, void 0, function () {
    var url, timeSeries;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = "markets/history?symbol=".concat(ticker, "&interval=daily&start=").concat(start, "&end=").concat(end);
...
var testForDate = function (date) { return __awaiter(void 0, void 0, void 0, function () {
    var filter, calls, callsToCheck, _loop_1, x, selectedResults, x, call, symbol, priceHistory, dayPriceHistory, lastPrice, winners, losers, totalProfit, totalPremium;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                filter = {
                ...
                _loop_1 = function (x) {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                call = calls[x];
                                return [4 /*yield*/, getHistoricalData(call.underlying, '2022-02-01', call.date)];
                            case 1:
                                history = _b.sent();
            ...
            case 7:
                priceHistory = _a.sent();
                dayPriceHistory = priceHistory.filter(function (x) { return x.date.toISOString().split('T')[0] === date; });
                if (dayPriceHistory.length > 0) {
                    lastPrice = dayPriceHistory.reverse()[0];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                _a.label = 2;
            case 2:
                if (!(x < dates.length)) return [3 /*break*/, 5];
                return [4 /*yield*/, testForDate(dates[x])];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4:
