...
var closeLongPositions_1 = require("./core/closeLongPositions");
var masterCron_1 = require("./core/masterCron");
var launchCrons = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        new CronJob('0 50 9 * * 1-5', masterCron_1.masterCron, null, true, 'America/New_York');
        // Close expiring options one hour before Tradier does it
        new CronJob('0 15 14 * * 1-5', function () { return (0, masterCron_1.cronFunc)(closeExpiringPositions_1.closeExpiringPositions, 'CloseExp'); }, null, true, 'America/New_York');
        // Close long positions at market close
        new CronJob('0 45 15 * * 1-5', function () { return (0, masterCron_1.cronFunc)(closeLongPositions_1.closeLongPositions, 'CloseLong'); }, null, true, 'America/New_York');
        // Run every day at 4:10 NY time
        // 10 mins after market close
        new CronJob('0 10 16 * * *', function () { return (0, masterCron_1.cronFunc)(logger_1.clearOldLogs, 'Housekeeping'); }, null, true, 'America/New_York');
