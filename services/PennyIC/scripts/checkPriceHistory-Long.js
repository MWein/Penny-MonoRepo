...
var checkPriceHistory = function () { return __awaiter(void 0, void 0, void 0, function () {
    var keyToUse, positions, longPositions, longCostBasis, earliestAquiredDate, datesToCalc, positionsWithPriceHistory, today, x, position, start, quotes, pos, quote, buyPrice, currentSalePrice, gainLoss;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                positions = _a.sent();
                longPositions = positions.filter(function (x) { return x.quantity > 0; });
                longCostBasis = longPositions.reduce(function (acc, pos) { return acc + pos.cost_basis; }, 0);
                earliestAquiredDate = longPositions.reduce(function (acc, pos) {
                ...
                _a.label = 2;
            case 2:
                if (!(x < longPositions.length)) return [3 /*break*/, 5];
                position = longPositions[x];
            ...
            case 3:
                ...
                pos = __assign(__assign({}, position), { quotes: quotes });
                quote = pos.quotes.find(function (x) { return x.date === '2022-03-22'; });
                if (!quote) {
                    return [3 /*break*/, 4];
                }
                buyPrice = pos.cost_basis;
                currentSalePrice = Number((quote[keyToUse] * 100).toFixed(0));
                gainLoss = currentSalePrice - buyPrice;
