...
exports.checkThemTest = exports.selectThemTest = exports.getATMOptions = void 0;
...
var selectThemTest = function () { return __awaiter(void 0, void 0, void 0, function () {
    var start, selectedOptions, x, symbol, prices, atmOpts, putModel, callModel, sortedOpts, end;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                ...
                return [3 /*break*/, 1];
            case 6:
                sortedOpts = selectedOptions.sort(function (a, b) { return b.perc - a.perc; }).filter(function (x) { return x.perc > 5; }).reverse();
...
exports.selectThemTest = selectThemTest;
var checkThemTest = function () { return __awaiter(void 0, void 0, void 0, function () {
    var filter, matchingOptions, tradierPrices, currentPrices, optionsWithProfit;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                filter = {
            ...
            case 2:
                ...
                optionsWithProfit = matchingOptions.map(function (opt) {
                    var currentPrice = currentPrices.find(function (x) { return x.symbol === opt.symbol; }).price;
