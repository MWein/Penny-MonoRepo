...
var scribe_1 = require("../../packages/scribe");
// Possible removal
...
var launchCrons = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        new CronJob('0 31 9 * * 1-5', function () { return cronFunc(scribe_1.saveAllSelections, 'RNS Init'); }, null, true, 'America/New_York');
        new CronJob('0 0 11 * * 1-4', function () { return cronFunc(sellIronCondor_1.sellIronCondors, 'ShortIC'); }, null, true, 'America/New_York');
        new CronJob('0 0 13 * * 1-4', function () { return cronFunc(sellIronCondor_1.sellIronCondors, 'ShortIC'); }, null, true, 'America/New_York');
