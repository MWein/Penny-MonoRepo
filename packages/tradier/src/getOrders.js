...
var getOrder = function (orderId) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, (0, callTradierHelper_1.callTradierHelper)("accounts/".concat(process.env.ACCOUNTNUM, "/orders/").concat(orderId), 'order', null, false)];
}); }); };
exports.getOrder = getOrder;
var getOrders = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, (0, callTradierHelper_1.callTradierHelper)("accounts/".concat(process.env.ACCOUNTNUM, "/orders"), 'orders', 'order', true)];
}); }); };
