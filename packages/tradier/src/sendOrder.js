...
exports.cancelOrders = exports.multilegOptionOrder = exports.buyToCloseMarket = exports.buyToClose = exports.sellToCloseLimit = exports.sellToClose = exports.sellToOpen = exports.buyToOpen = exports.buy = exports._sendOrder = void 0;
...
exports.buy = buy;
var buyToOpen = function (symbol, option_symbol, quantity, limitPrice) { return __awaiter(void 0, void 0, void 0, function () {
    var body, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, exports._sendOrder)(body, "Buy-to-open ".concat(quantity, " ").concat(symbol), "Buy-to-open ".concat(quantity, " ").concat(symbol, " Failed"))];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
        }
...
var sellToCloseLimit = function (symbol, option_symbol, quantity, price) { return __awaiter(void 0, void 0, void 0, function () {
    var body, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
exports.sellToCloseLimit = sellToCloseLimit;
...
var cancelOrders = function (orderIDs) { return __awaiter(void 0, void 0, void 0, function () {
    var chunks, x, chunk_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                chunks = (0, lodash_1.chunk)(orderIDs, 50);
                x = 0;
                _a.label = 1;
            case 1:
                if (!(x < chunks.length)) return [3 /*break*/, 4];
                chunk_1 = chunks[x];
                return [4 /*yield*/, Promise.all(chunk_1.map(function (orderId) { return __awaiter(void 0, void 0, void 0, function () {
                        var url, e_2;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                ...
                                case 3:
                                    ...
                                    logUtil.log({
                                        type: 'error',
                                        message: "Could not cancel ".concat(orderId),
                                    });
                                    return [3 /*break*/, 4];
                                case 4: return [2 /*return*/];
                            }
