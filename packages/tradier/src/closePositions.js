...
var getPrices_1 = require("./getPrices");
...
var closePositionsIndividual = function (positions) { return __awaiter(void 0, void 0, void 0, function () {
    var optionPositions, prices, positionsWithPrices, chunks, x, chunk_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                optionPositions = positions.filter(function (pos) { return (0, option_symbol_parser_1.isOption)(pos.symbol); });
                ...
                return [4 /*yield*/, (0, getPrices_1.getPrices)(optionPositions.map(function (pos) { return pos.symbol; }))];
            case 1:
                prices = _a.sent();
                positionsWithPrices = optionPositions.map(function (pos) {
                    var _a;
                    return (__assign(__assign({}, pos), { sellPrice: Number((((_a = prices.find(function (price) { return price.symbol === pos.symbol; })) !== null && _a !== void 0 ? _a : { price: 0 }).price * 0.90).toFixed(2)) }));
                });
                chunks = (0, lodash_1.chunk)(positionsWithPrices, 10);
                x = 0;
                _a.label = 2;
            case 2:
                if (!(x < chunks.length)) return [3 /*break*/, 5];
                chunk_1 = chunks[x];
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, (0, sendOrder_1.sellToCloseLimit)((0, option_symbol_parser_1.getUnderlying)(pos.symbol), pos.symbol, pos.quantity, pos.sellPrice)];
                                case 1:
                                    _a.sent();
                                    return [3 /*break*/, 4];
