...
exports.clearOldLogs = exports.getCronLogs = exports.getLogs = exports.logCron = exports.log = exports._logWithMessage = exports._logWithObject = void 0;
...
exports.log = log;
var logCron = function (cronName, success, errorMessage) { return __awaiter(void 0, void 0, void 0, function () {
    var newLog_1, newLog, e_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                if (!errorMessage) return [3 /*break*/, 2];
                newLog_1 = new db_models_1.cronModel({ cronName: cronName, success: success, errorMessage: errorMessage });
                return [4 /*yield*/, newLog_1.save()];
            case 1:
                _a.sent();
                return [2 /*return*/];
            case 2:
                newLog = new db_models_1.cronModel({ cronName: cronName, success: success });
                return [4 /*yield*/, newLog.save()];
            case 3:
                _a.sent();
                return [3 /*break*/, 5];
...
var getCronLogs = function () { return __awaiter(void 0, void 0, void 0, function () {
    var logs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_models_1.cronModel.find().sort({ date: -1 }).select('-_id -__v')];
            case 1:
                logs = _a.sent();
                return [2 /*return*/, logs];
        }
...
var clearOldLogs = function () { return __awaiter(void 0, void 0, void 0, function () {
    var DELETEOLDERTHANDAYS, today, priorDate, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, db_models_1.cronModel.deleteMany({ date: { $lte: priorDate } })];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
